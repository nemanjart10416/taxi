                                        ...
                                        <tr>
                                            <td class="pad"
                                                ...
                                                <div class="alignment" align="center" style="line-height:10px"><img
                                                        src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/0db9f180-d222-4b2b-9371-cf9393bf4764/0bd8b69e-4024-4f26-9010-6e2a146401fb/Email%20Templates%20Assets%20Folder/Logos/yourlogohere_icon_black.png_thumb.png"
                                                        style="display:block;height:auto;border:0;width:48px;max-width:100%"
                                                        width="48" alt="Alternate text" title="Alternate text"></div>
                                            </td>
                                        </tr>
                                    </table>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="divider_inner"
                                                                style="font-size:1px;line-height:1px;border-top:1px solid #dedede">
                                                                <span>&#8202;</span></td>
                                                        </tr>
                                                    </table>
                                                </div>
                ...
                <tr>
                    <td>
                        <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0"
                               role="presentation"
                               style="mso-table-lspace:0;mso-table-rspace:0;color:#000;width:600px" width="600">
                            <tbody>
                            <tr>
                                <td class="column column-1" width="100%"
                                    style="mso-table-lspace:0;mso-table-rspace:0;font-weight:400;text-align:left;padding-bottom:30px;padding-left:20px;padding-right:20px;padding-top:5px;vertical-align:top;border-top:0;border-right:0;border-bottom:0;border-left:0">
                                    <table class="text_block block-1" width="100%" border="0" cellpadding="10"
                                           cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td class="pad">
                                                <div style="font-family:sans-serif">
                                                    <div class
                                                         style="font-size:12px;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;mso-line-height-alt:14.399999999999999px;color:#333;line-height:1.2">
                                                        <p style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
                                                            <span style="font-size:30px;">NEW MESSAGE</span></p></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="text_block block-2" width="100%" border="0"
                                        ...
                                        <tr>
                                            <td class="pad">
                                                <div style="font-family:sans-serif">
                                                    <div class
                                                         style="font-size:12px;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;mso-line-height-alt:21.6px;color:#333;line-height:1.8">
                                                        ...
                                                        <p style="margin:0;text-align:center;mso-line-height-alt:30.6px">
                                                            <span style="font-size:17px;">'.$message.'</span></p></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
...
function ride_confirm_admin_en($name,$date,$time,$full_address,$full_address_a1,$full_address_a2,$phone,$email,$people,$child_seat,$payment,$suitcases,
                                  $comment,$price,$return_ride,$return_date="", $return_time="",$return_address="",$return_address_a1="",$r_people="",
                                  $r_suitcases="",$r_child_seats="",$r_price=""){
    global $company_phone, $company_email, $website;
                                                ...
                                                <tr>
                                                    <td class="pad">
                                                        <div style="font-family:sans-serif">
                                                            <div class style="font-size:12px;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;mso-line-height-alt:14.399999999999999px;color:#333;line-height:1.2">
                                                                <p style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
                                                                    <span style="font-size:30px;">Airport taxi Wien, new ride</span>
                                                                </p>
                                                                </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="pad">
                                                        <div style="font-family:sans-serif">
                                                            <div style="font-size:12px;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;mso-line-height-alt:21.6px;color:#333;line-height:1.8">
                                                                <p style="margin:0;text-align:left;mso-line-height-alt:30.6px">
                                                                    <span style="font-size:17px;">Customer '.$name.'</span>
                                                                </p>
                                                                <p style="margin:0;text-align:left;mso-line-height-alt:21.6px">&nbsp;</p>
                                                                <p style="margin:0;text-align:left;mso-line-height-alt:30.6px">
                                                                    <span style="font-size:17px;">
                                                                        You have new ride in admin panel
                                                                    </span>
                                                                </p>
                                                                <p style="margin:0;text-align:left;mso-line-height-alt:21.6px">&nbsp;</p>
                                                                <p style="margin:0;text-align:left;mso-line-height-alt:30.6px">
                                                                    <em><strong>ride:</strong></em>
                                                                </p>
                                                                <p style="margin:0;text-align:left;mso-line-height-alt:30.6px">
                                                                    Date: '.$date.'
                                                                </p>
