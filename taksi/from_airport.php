...
<div class="container booking-form mt-5 mb-5">
    ...
    <div><h1 class="heading-primary align colotext">taksi od aerodruma</h1></div>
    <div class="row">
        <div class="col-12 col-md-6">
            <form class="container-fluid text-center form_1" method="POST">
                ...
                <div class="row section">
                    <div class="col-12">
                        <p class="mb-0 text-uppercase title text-shadow-2 title mt-3 h3">kontakt</p>
                        <div class="dlab-separator-outer mb-0">
                            <div class="dlab-separator bg-dark style-skew mb-2 mt-2"></div>
                        </div>
                    </div>
                ...
                <div class="row section">
                    <div class="col-12">
                        <p class="mb-0 text-uppercase title text-shadow-2 title mt-4 h3">opcije</p>
                        <div class="dlab-separator-outer mb-0">
                            <div class="dlab-separator bg-dark style-skew mb-2 mt-2"></div>
                        </div>
                    </div>
