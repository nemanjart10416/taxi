        ...
        <div class="container-fluid pt-4 px-4" id="google_translate_element">
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                        <i class="fa text-primary">
                            <svg class="fill1" width="50" height="50" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2 2H4V18H20V20H2V2M6 16V8H10V16H6M11 16V4H15V16H11M16 16V11H20V16H16Z" />
                            </svg>
                        </i>
                        <div class="ms-3">
                            <p class="mb-2 en">Total Sale</p>
                            <p class="mb-2 sr">ukupna zarada</p>
                            <p class="mb-2 de">Ausverkauf</p>
                            <h6 class="mb-0">
                                <?php
                                echo Ride::getAllSale()."e";
                                ?>
                            </h6>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                        <i class="fa fa-3x text-primary">
                            <svg class="fill1" width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div class="ms-3">
                            <p class="mb-2 en">Today rides</p>
                            <p class="mb-2 sr">Danasnje voznje</p>
                            <p class="mb-2 de">Heute fährt</p>
                            <h6 class="mb-0">
                                <?php
                                echo Ride::getTodaySaleCount();
                                ?>
                            </h6>
                        </div>
                    </div>
                    ...
                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                        <i class="fa fa-3x text-primary">
                            <svg width="50" height="50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path class="fill1" d="M10 13H14M19 9V20H5V9M19 9H5M19 9C19.5523 9 20 8.55228 20 8V5C20 4.44772 19.5523 4 19 4H5C4.44772 4 4 4.44772 4 5V8C4 8.55228 4.44772 9 5 9" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </i>
                        <div class="ms-3">
                            <p class="mb-2 en">Total rides</p>
                            <p class="mb-2 sr">Sve voznje</p>
                            <p class="mb-2 de">Fahrten insgesamt</p>
                            <h6 class="mb-0">
                                <?php
                                echo Ride::getAllSaleCount();
                                ?>
                            </h6>
                        </div>
                    </div>
