...
//$ride_id = $_GET["change"];
    ...
    if (get_csrf_token() !== $csrfToken) {
        ...
        $ans = Validate::changeRidePrice();

        if($ans===true){
            $price = user_input($_POST["price"]);
            Ride::updatePrice($ride_id,$price);
            $ride_to_change = Ride::getById($ride_id);
        }
    }
}
...
//$ride_id = $_GET["change"];
    ...
    if (get_csrf_token() !== $csrfToken) {
        ...
        $ans = Validate::changeRideOptions();

        if($ans===true){
            $ans = change_ride_options($ride_id);
            $ride_to_change = Ride::getById($ride_id);
        }
    }
}
        ...
        <div class="container-fluid mt-3">
            ...
            <div class="row mt-3">
                <div class="col-sm-12 col-md-6">
                    <div class="bg-secondary rounded h-100 p-4">
                        <h6 class="mb-1">Change basic information</h6>
                        <p class="mb-0">status: <?php echo $ride_to_change->getStatus(); ?></p>
                        <?php
                        if(!is_null($ride_to_change->getDriverId())){
                            $driver = Driver::getById($ride_to_change->getDriverId());
                            ?>
                            <p class="mb-0">Driver: <?php echo $driver->getName(); ?> <?php echo $driver->getLastName(); ?> (<?php echo $driver->getUsername(); ?>)</p>
                            <?php
                        }
                        ?>
                        <p class="mb-3">price: <?php echo $ride_to_change->getPrice(); ?> Eur</p>
                        ...
                        <form class="container-fluid" action="update-ride.php?change=<?php echo $ride_id; ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="text" class="form-control" id="price" name="price" value="<?php echo htmlentities($ride_to_change->getPrice());?>">
                                </div>
                                <div class="col-12 col-md-3">
                                    <button type="submit" class="btn btn-primary" name="change_price">change price</button>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <form class="container-fluid" action="update-ride.php?change=<?php echo $ride_id; ?>"
                                ...
                                <div class="row section">
                                    <div class="col-12">
                                        ...
                                        <?php
                                        if (!is_null($ride_to_change->getAdditionalAddress1()) && $ride_to_change->getAdditionalAddress1()>0) {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <select class="form-select form-select-sm mb-3"
                                                        ...
                                                        <?php
                                                        if (!is_null($ride_to_change->getAdditionalAddress1())) {
                                                            $districts = District::getAllByCity($aa1_city_id);
                                                            foreach ($districts as $district) {
                                                                ?>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <select class="form-select form-select-sm mb-3"
                                                        ...
                                                        <?php
                                                        if (!is_null($ride_to_change->getAdditionalAddress1())) {
                                                            $streets = Street::getAllByDistrict($aa1_district_id);
                                                            foreach ($streets as $street) {
                                                                ?>
                                ...
                                <?php
                                if (!is_null($ride_to_change->getAdditionalAddress2()) && $ride_to_change->getAdditionalAddress2()>0) {
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <div class="container-fluid <?php echo (is_null($ride_to_change->getAdditionalAddress2())) ? "closed" : ""; ?> ps-0 pe-0 additional"
                                            ...
                                            <div class="row">
                                                    ...
                                                    <select class="form-select form-select-sm mb-3"
                                                        ...
                                                        foreach ($cities as $city) {
                                                            if (is_null($ride_to_change->getAdditionalAddress2())) {
                                                                ...
                                                                ?>
                                                                <option <?php echo ($city->getId() == $aa2_city_id) ? "selected" : ""; ?>
                                                                        value="<?php echo $city->getId(); ?>"><?php echo $city->getName(); ?></option>
                                                                <?php
                                                            }
                                                        }
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    ?>
                                                    <select class="form-select form-select-sm mb-3"
                                                            name="postcodeAditional2" id="postcodeAditional2" <?php echo $state; ?>>
                                                        <option value="0">Postcode</option>
                                                        <?php
                                                        if (!is_null($ride_to_change->getAdditionalAddress2())) {
                                                            $districts = District::getAllByCity($aa2_city_id);
                                                            foreach ($districts as $district) {
                                                                ?>
                                                                <option <?php echo ($district->getId() == $aa2_district_id) ? "selected" : ""; ?>
                                                                        value="<?php echo $district->getId(); ?>"><?php echo $district->getName(); ?></option>
                                                                <?php
                                                            }
                                                        }
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <select class="form-select form-select-sm mb-3"
                                                            name="streetAditional2" id="streetAditional2" <?php echo $state; ?>>
                                                        <option value="0">Street</option>
                                                        <?php
                                                        if (!is_null($ride_to_change->getAdditionalAddress1())) {
                                                            $streets = Street::getAllByDistrict($aa2_district_id);
                                                            foreach ($streets as $street) {
                                                                ?>
                                                                <option <?php echo ($street->getId() == $aa2_street_id) ? "selected" : ""; ?>
                                                                        value="<?php echo $street->getId(); ?>"><?php echo $street->getName(); ?></option>
                                                                <?php
                                                            }
                                                        }
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" class="ToCheck form-control form-select-sm"
                                                           ...
                                                           id="numberAditional2" value="<?php echo htmlentities($ride_to_change->getAdditionalAddress1StreetNumber()); ?>">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row section">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select name="people" id="people" class="form-select form-select-sm mb-3">
                                            <?php
                                                for($i=1;$i<=8;$i++){
                                                    ?>
                                                        <option <?php echo ($ride_to_change->getNumberOfPeople()==$i)? "selected" : ""; ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php
                                                }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select class="form-select form-select-sm mb-3" name="suitcases" id="suitcases">
                                            ...
                                            for($i=0;$i<=8;$i++){
                                                ?>
                                                <option <?php echo ($ride_to_change->getNumberOfSuitcases()==$i)? "selected" : ""; ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6 child_seats">
                                        ...
                                        <select class="form-select form-select-sm mb-3" name="babySeat" id="babySeat">
                                            ...
                                            for($i=0;$i<=8;$i++){
                                                ?>
                                                <option <?php echo ($ride_to_change->getNumberOfBabySeats()==$i)? "selected" : ""; ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6 child_seats">
                                        ...
                                        <select class="form-select form-select-sm mb-3" name="childSeat" id="childSeat">
                                            ...
                                            for($i=0;$i<=8;$i++){
                                                ?>
                                                <option <?php echo ($ride_to_change->getNumberOfChildSeats()==$i)? "selected" : ""; ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6 child_seats">
                                        ...
                                        <select class="form-select form-select-sm mb-3" name="raisedSeat" id="raisedSeat">
                                            ...
                                            for($i=0;$i<=8;$i++){
                                                ?>
                                                <option <?php echo ($ride_to_change->getNumberOfRaisedSeats()==$i)? "selected" : ""; ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label></label>
                                        <input type="text" class="form-control form-select-sm mb-3 <?php echo ($ride_to_change->getFromTo()=="to")? "visually-hidden" : ""; ?>"
                                               placeholder="flight number" name="flightnumber" id="flightnumber" value="<?php echo htmlentities($ride_to_change->getFlightNumber()); ?>">
                                    </div>
                                </div>
