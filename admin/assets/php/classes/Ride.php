...
class Ride
{
    ...
    public function __construct(
        $id, $name, $email, $mobile, $from_to, $number_of_people, $number_of_suitcases,
        $number_of_baby_seats, $number_of_child_seats, $number_of_raised_seats,
    ...
    public function getAdditional() {
        $info = '
            ...
            <span> <b>'.$this->getNumberOfSuitcases().'</span></b>
            <hr class="mt-0 mb-0">
        ';
    ...
    public function getAddressInfo(){
        ...
        if($this->getFromTo()=="to"){
            ...
            $info = '
                ...
                <span class="sr">aerodrum</span>
                <span class="de">Flughafen</span>
                <hr class="mt-0 mb-0">
                <b>
            ';
        }
    ...
    public function getRideInfo(){
        return '
            ...
            <span>'.$this->getRideTime().' <b>'.$this->countdown().'</b></span>
            <hr class="mt-0 mb-0">
    ...
    public static function search(){
        ...
        if($s>0){
            ...
            while ($row = $result->fetch_assoc()){
                $rides [] = new Ride(
                    $row["id"], $row["name"], $row["email"], $row["mobile"], $row["from_to"], $row["number_people"], $row["number_suitcases"],
                    $row["number_baby_seats"],$row["number_child_seats"],$row["number_raised_seats"],
        ...
        try{
            ...
            $query = "
                ...
                SET from_to=:from_to, price=:price,flight_number=:flight_number,streets_id=:streets_id,street_number=:street_number,aa1=:aa1,
                    aa1_number=:aa1_number,aa2=:aa2,aa2_number=:aa2_number,number_people=:number_people,number_suitcases=:number_suitcases,
                    number_child_seats=:number_child_seats, number_raised_seats=:number_raised_seats, number_baby_seats=:number_baby_seats
                WHERE id=:ride_id
            ";
            $sth = $konekcija->prepare($query);
            ...
            $sth->bindParam(':number_baby_seats', $num_baby_seats);
            $sth->bindParam(':number_raised_seats', $num_raised_seats);
    ...
    public function setNumberOfBabySeats($number_of_baby_seats){
        $this->number_of_baby_seats = $number_of_baby_seats;
    }
    ...
    public function setNumberOfRaisedSeats($number_of_raised_seats){
        $this->number_of_raised_seats = $number_of_raised_seats;
    }
